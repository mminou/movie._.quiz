...
class MoviesLoaderTests: XCTestCase {
    func testSuccessLoading() throws {
        // G
        let stubNetworkClien = StubNetworkClient(emulateError: false)
        let loader = MoviesLoader(networkClient: stubNetworkClien)
    ...
    func testFailureLoading() throws {
        // G
        let stubNetworkClien = StubNetworkClient(emulateError: true)
        let loader = MoviesLoader(networkClient: stubNetworkClien)
